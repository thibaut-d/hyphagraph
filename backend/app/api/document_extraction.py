...
async def extract_from_document(
    ...
    logger.info(f"Document extraction requested for source {source_id} by user {current_user.email}")
...
async def upload_and_extract(
    ...
    logger.info(
        f"Upload and extract requested for source {source_id} by user {current_user.email}, "
