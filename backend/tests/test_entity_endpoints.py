...
class TestEntityEndpoints:
    ...
    async def test_list_entities_no_auth(self):
    ...
    async def test_create_entity_with_auth(self, mock_current_user):
    ...
    async def test_create_entity_validation(self):
    ...
    async def test_create_entity_invalid_kind(self):
