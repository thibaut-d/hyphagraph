        ...
        treats: [
          {
            ...
            roles: [
              { id: "role-1", relation_revision_id: "rev-1", entity_id: "drug-1", entity_slug: "aspirin", role_type: "subject" },
              { id: "role-2", relation_revision_id: "rev-1", entity_id: "condition-1", entity_slug: "migraine", role_type: "object" },
            ],
        ...
        effect: [
          {
            ...
            roles: [
              { id: "role-1", relation_revision_id: "rev-1", entity_id: "drug-1", entity_slug: "aspirin", role_type: "subject" },
              { id: "role-2", relation_revision_id: "rev-1", entity_id: "outcome-1", entity_slug: "pain relief", role_type: "object" },
            ],
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            status: "confirmed" as const,
